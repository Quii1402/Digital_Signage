namespace KDTVN_Shared.Helper
{
    public class DBConnection
    {
        ...
        #region KDTVN_DIGITAL_SIGNAGE
        public const string KDTVN_DIGITAL_SIGNAGE = @"Data Source=10.170.162.45;Initial Catalog=KDTVN_DIGITAL_SIGNAGE;User ID=sa;Password=123@4dmin";
        #endregion
